...
class Home extends CI_CONTROLLER{
    ...
    public function index(){
        ...
        $data['peserta_reguler'] = COUNT($this->Akademik_model->get_peserta_reguler_aktif());
        // kelas
        $data['jadwal_pv_khusus'] = COUNT($this->Akademik_model->get_kelas_pv_khusus_aktif());
        $data['jadwal_pv_luar'] = COUNT($this->Akademik_model->get_kelas_pv_luar_aktif());
