...
<div class="modal fade" id="modalTambahKelasReguler" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" tabindex="-1" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form action="<?= base_url() ?>kelas/add_kelas_reguler" method="post">
          ...
          <div class="d-flex justify-content-end">
            <input type="submit" value="Tambah Kelas" class="btn btn-sm btn-info" id="btn-add-kelas">
          </div>
        </form>
      </div>
    </div>
...
<a href="#modalTambahKelasReguler" data-bs-toggle="modal" class="btn btn-success btn-sm mb-3 modalTambahKelasReguler" data-bs-target="#modalTambahKelasReguler">Tambah Kelas Reguler</a>
