        ...
        <div class="card-body">
            <table id="dataTable" class="table table-hover align-items-center mb-0 text-dark text-sm">
                <thead>
                    ...
                    <th class="text-uppercase text-dark text-xxs font-weight-bolder w-1">Koordinator</th>
                    ...
                    <th class="text-uppercase text-dark text-xxs font-weight-bolder text-wrap">Alamat</th> 
                ...
                <?php 
                    ...
                    <tr>
                      ...
                      <td><?= $history['hari']?></td>
                      <td><?= $history['jam']?></td>
                      <td class="text-wrap"><?= $history['alamat']?></td>
                      <td>
